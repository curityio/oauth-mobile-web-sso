...
class ApplicationConfiguration {
    ...
    private lateinit var issuerPath: String
    private lateinit var nonceAuthenticatorPath: String
    lateinit var clientID: String
    lateinit var redirectUri: String
    lateinit var scope: String
    private lateinit var spaPath: String
    ...
    fun getSpaUri(): Uri {
        return Uri.parse("$baseUrl$spaPath")
    }
}
